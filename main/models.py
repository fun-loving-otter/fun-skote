...
class Data(models.Model):
    ...
    founded_date = models.DateField(max_length=255, null=True, blank=True, verbose_name='Founded Date')
    ...
    last_funding_date = models.DateField(max_length=255, null=True, blank=True, verbose_name='Last Funding Date')
    ...
    ipo_date = models.DateField(max_length=255, null=True, blank=True, verbose_name='IPO Date')
