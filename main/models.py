...
class Data(models.Model):
    ...
    organization_name = models.CharField(max_length=1023, null=True, blank=True, verbose_name='Organization Name')
    crunchbase_company_url = models.CharField(max_length=1023, null=True, blank=True, verbose_name='Crunchbase Company URL')
    founded_date = models.DateField(max_length=1023, null=True, blank=True, verbose_name='Founded Date')
    ...
    headquarters = models.CharField(max_length=1023, null=True, blank=True, verbose_name='Headquarters')
    ...
    last_funding_date = models.DateField(max_length=1023, null=True, blank=True, verbose_name='Last Funding Date')
    ...
    estimate_revenue = models.CharField(max_length=1023, null=True, blank=True, verbose_name='Estimate Revenue')
    ...
    number_of_employees = models.CharField(max_length=1023, null=True, blank=True, verbose_name='Number of Employees')
    total_funding_amount = models.CharField(max_length=1023, null=True, blank=True, verbose_name='Total Funding Amount')
    total_equity_funding = models.CharField(max_length=1023, null=True, blank=True, verbose_name='Total Equity Funding')
    ...
    ipo_date = models.DateField(max_length=1023, null=True, blank=True, verbose_name='IPO Date')
    money_raised_at_ipo = models.CharField(max_length=1023, null=True, blank=True, verbose_name='Money Raised at IPO')
    valuation_at_ipo = models.CharField(max_length=1023, null=True, blank=True, verbose_name='Valuation at IPO')
